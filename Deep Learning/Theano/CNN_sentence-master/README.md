...
And Chinese can download from here http://pan.baidu.com/s/1kTCQqft.
...
in the right format. Then we can choose which data to use while at the beginning of the CNN.
